...
parser.add_argument('-s','--username', help='Username from wordpress.')
...
parser.add_argument('-u','--url', required=True, help='Target URL, full path. ex: http://127.0.0.1/xmlrpc.php')
